...
from linearize import linearize, linearize_given_chol_cov
...
def test_linearize_init(seed, x_dim) -> None:
    ...
    mat_given_chol_cov, shift_given_chol_cov = linearize_given_chol_cov(
...
def test_linearize_trans_model(seed, x_dim) -> None:
    ...
    dynamics_mat, dynamics_shift, dynamics_chol_cov = linearize(
...
def test_linearize_obs_model(seed, x_dim, y_dim) -> None:
    ...
    obs_mat_given_chol_cov, obs_shift_given_chol_cov = linearize_given_chol_cov(
    ...
    obs_mat, obs_shift, obs_chol_cov = linearize(
