...
2. Make sure to start each code block with `{.python #code_block_name}`. See the [`docs/examples/quickstart.md`](https://github.com/state-space-models/cuthbert/blob/main/docs/examples/quickstart.md) example for reference.
